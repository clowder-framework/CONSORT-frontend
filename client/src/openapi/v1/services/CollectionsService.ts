...
export class CollectionsService {
	 ...
	 * @throws ApiError
	 */
	public static postCollections1(
		id: string,
	): CancelablePromise<any> {
		return __request({
			method: 'POST',
	 ...
	 * @throws ApiError
	 */
	public static deleteCollections1(
		days?: number,
	): CancelablePromise<any> {
		return __request({
			method: 'DELETE',
	 ...
	 * @throws ApiError
	 */
	public static getCollections10(
		collId: string,
	): CancelablePromise<any> {
		return __request({
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static postCollections6(
		id: string,
	): CancelablePromise<any> {
		return __request({
			method: 'POST',
	 ...
	 * @throws ApiError
	 */
	public static getCollections12(
		collId: string,
	): CancelablePromise<any> {
		return __request({
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static postCollections7(
		collId: string,
	): CancelablePromise<any> {
		return __request({
			method: 'POST',
	 ...
	 * @throws ApiError
	 */
	public static getCollections14(
		collId: string,
	): CancelablePromise<any> {
		return __request({
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static postCollections9(
		requestBody?: {
			name: string;
			description?: string;
			space?: string;
	 ...
	 * @throws ApiError
	 */
	public static postCollections12(
		collId: string,
	): CancelablePromise<any> {
		return __request({
			method: 'POST',
